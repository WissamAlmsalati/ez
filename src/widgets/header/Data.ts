// Apps, Page Links, Search, Messages, Notification, Profile data

export interface appsLinkType {
  href: string;
  title: string;
  subtext: string;
  avatar: string;
...
export const appsLink: appsLinkType[] = [
  {
    href: "/apps/chats",
...
export const pageLinks: LinkType[] = [
  { href: "/theme-pages/pricing", title: "Pricing Page" },
  { href: "/auth/auth1/login", title: "Authentication Design" },
  { href: "/auth/auth1/register", title: "Register Now" },
  { href: "/404", title: "404 Error Page" },
  { href: "/apps/kanban", title: "Kanban App" },
  { href: "/apps/user-profile/profile", title: "User Application" },
  { href: "/apps/blog/post", title: "Blog Design" },
  { href: "/apps/ecommerce/checkout", title: "Shopping Cart" },
];
